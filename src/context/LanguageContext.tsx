...
const translations = {
  ...
  zh: {
    ...
    'home.work_title': '工作',
    'home.work_desc': '大家好，我叫 Ying，今年二十一岁，目前仍是 HUTECH 的在校生，即将在 2025–2026 学年从信息技术专业毕业。我的职业理想是成为一名全栈开发工程师。我致力于解决客户各类需求，并以专业的代码能力提供可靠的技术支持。这是我创建的第一个博客，用于分享我四年来的学习经验与知识。感谢各位访问我的网站，谨致谢意。',
