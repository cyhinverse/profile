...
import { SiFastapi, SiTailwindcss, SiRedis, SiRabbitmq, SiMongodb, SiPostgresql } from 'react-icons/si';
              ...
              {shouldRender3D ? (
                <Suspense fallback={
                  <div className="h-full w-full flex items-center justify-center relative">
                    <div className="absolute w-[300px] h-[300px] rounded-full dark:opacity-20 opacity-50" style={{ background: 'radial-gradient(circle, rgba(220,56,45,0.1) 0%, rgba(168,162,158,0.15) 100%)' }} />
...
{TECH_STACK.map(({ Icon, color, name }) => (
            ...
            >
              ...
              <div 
                className="relative z-10 transform-gpu transition-transform duration-200 ease-out group-hover:scale-110 group-hover:-translate-y-1"
              >
                <Icon 
                  size={40} 
